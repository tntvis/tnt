var my_tree = function () {
	...
	epeek_tree = epeek.tree(undefined, cluster);
	...
	if (node !== undefined) {
	    epeek_tree.traverse(node, function(n) {n.present_node = 1});
	}
    };

    var reset_tree = function (node) {
	if (node !== undefined) {
	    epeek_tree.traverse(node, function(n) {n.present_node = 0; n.real_present = 0;});
	}
    }

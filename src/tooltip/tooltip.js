...
//     var path = epeek.utils.script_path("ePeek.js");
	...
	tooltip_div.append("span")
	    ...
	    .style("top", "-10px")
	    .append("img")
	    .attr("src", epeek.tooltip.images.close)

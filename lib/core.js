...
//     var isZoom = prevZoomLevel === d3.event.scale;
    // This fixes before-the-beginning panning
    var currDomain = xScale.domain();
    var newDomainLeft = d3.max([currDomain[0], limits.left]);
    var newDomainRight = d3.min([currDomain[1], limits.right]);

    xScale.domain([newDomainLeft, newDomainRight]);

//     if (currDomain[0] < limits.left) {
// 	if (fivePrimeEdge === undefined) {
// 	    fivePrimeEdge = currDomain[1]
// 	}
// 	currDomain = ([limits.left, fivePrimeEdge]);
// 	xScale.domain(currDomain);
// 	if (drag_allowed) {
...
// 	}
// 	xScale.domain([threePrimeEdge, limits.right]);
// 	if (drag_allowed) {
// 	    zoomEventHandler.x(xScale);
// 	}
//     } else {

...
var gene_color_cbak = function(){return fgColor};
...
/** <strong>start</strong> plots the genome browser and starts listening for mouse events on it.
    ...
    TODO: I think this doesn't need to be part of the exported API. startOnOrigin is safer (maybe change name?)
*/
...
*/
// TODO: It may be better if this method goes out. The same behavior (but much simpler) may come from the gBrowser.genes_callback and the gBrowser.gene_info_callback methods
...
// gBrowser.gene_color = function(cbak) {
//     if (!arguments.length) {
// 	return gene_color_cbak;
//     }
//     gene_color_cbak = cbak;
//     return gBrowser;
// };

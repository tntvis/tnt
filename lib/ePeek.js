var epeek = function() {
	...
	var src = d3.select(scripts[i]).attr("src");
	console.log(src);
	if (src.indexOf("ePeek") !== -1) {
	    console.log("FOUND!");
	    break;
	}
    }
    ...
    */
	...
	locRow
	    ...
	    .attr("src", "lib/green_button_small.png");
    };
	...
	if (currDomain[1] > chr_length) {
	    ...
	    d3.select("#ePeek_" + div_id + "_activity_signal").attr("src", "lib/red_button_small.png");

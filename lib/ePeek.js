var epeek = function() {
    ...
    */
    ...
    var plot = function () {
        ...
        // zoom
        // pane.call( d3.behavior.zoom().x(xScale).on("zoom", function() { if (~~xScale.invert(0) > 0) {zoom()} }) )
...
///*********************////
    ...
    */
    gBrowser.genes_layout = epeek_genes().height(height); //genes_layout;
...
var epeek_genes = function() {
    ...
    var max_slots = ~~(height / slot_types.expanded.slot_height) - 1;

...
//    var base_tree;
	...
	tree.update = function(is_new) {
	    ...
	    // TODO: I think this should be a package variable instead of being defined here
	    var max_depth_exit_node = 0;

	    // For a given exiting link, we take the children and pull them to the upstream node

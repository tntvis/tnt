  epeek.species_tree = function (newick) {
    ...
    // Needed here to update
      ...
      // TODO: This probably has to be adjusted for the vertical case
	...
	// TODO: This goes to the center of the div for the radial tree
	// so this should only be set when radial tree is selected
...
// 		});
	...
	vis.selectAll('g.leaf.ePeek_tree_node')
	    .append("circle")
            .attr("r", 4.5)
	...
	vis.selectAll('g.root.ePeek_tree_node')
	    .append('circle')
            .attr("r", 4.5)
            .attr('fill', 'steelblue')
            .attr('stroke', '#369')

...
epeek.tree = function () {
 "use strict";
	...
	console.log("MAX_LEAF_LABEL_LENGTH:" + max_leaf_label_length);
	...
	// TODO: Substitute 15 by the transform of the nodes
...
// 	}
	...
	tree.update = function() {
	    ...
	    console.log("N_LEAVES: " + n_leaves);
	    console.log("HEIGHT OF LEAVES: " + label.height()());
	    console.log("VIS WIDTH: " + layout.width());
	    console.log("SETTING CLUSTER SIZE TO:" + (n_leaves * label.height()()) + " : " + (layout.width() - layout.max_leaf_label_width()))
...
//		.delay(get_new_link_delay)
	    ...
	    new_node.on("click", tree.gene_info_callback);

...
var data = {
	...
	'anc1' : [
	    {
		name : 'NU4LM_ARCPU-ANC11',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    },
	    {
		name : 'NU4LM_ARCPU-ANC12',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    }
	],
	'anc5' : [
	    {
		name : 'NU4LM_ARCPU-ANC51',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    }
	],
	'anc3' : [
	    {
		name : 'NU4LM_ARCPU-ANC31',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    },
	    {
		name : 'NU4LM_ARCPU-ANC32',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    },
	    {
		name : 'NU4LM_ARCPU-ANC33',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    },
	    {
		name : 'NU4LM_ARCPU-ANC34',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    }
	],
	'anc4' : [
	    {
		name : 'NU4LM_ARCPU-ANC41',
		desc : 'NADH-ubiquinone oxidoreductase chain 4L'
	    }
	],
	'anc6' : [

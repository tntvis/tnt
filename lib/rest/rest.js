...
<li>fromPos : The start position of the region in the chr</li>
<li>toPos   : The end position of the region (fromPos < toPos always)</li>
</ul>
	    ...
	    @example
eRest.call ( url     : eRest.url.region ({ species : "homo_sapiens", chr : "13", fromPos : 32889611, toPos : 32973805 }),
             success : callback,
             error   : callback
	   );
	 */
...
eRest.call ( url     : eRest.url.species_gene ({ species : "human", gene_name : "BRCA2" }),
	...
	/** eRest.url.<strong>homologues</strong> returns the ensembl REST url to retrieve the homologues (orthologues + paralogues) of the given ensembl ID.
	    @param {object} obj - An object literal with the following fields:<br />
<ul>
<li>gene_id : The Ensembl ID of the gene</li>
</ul>
	    ...
	    @example
eRest.call ( url     : eRest.url.homologues ({ gene_id : "ENSG00000139618" }),
             success : callback,
             error   : callback
	   );
	 */
	...
	/** eRest.url.<strong>gene</strong> returns the ensembl REST url to retrieve the ensembl gene associated with
	    ...
	    @param {object} obj - An object literal with the following fields:<br />
<ul>
<li>gene_id : The name of the gene</li>
</ul>
	    ...
	    @example
eRest.call ( url     : eRest.url.gene ({ gene_id : "ENSG00000139618" }),
             success : callback,
             error   : callback
	   );
	 */
